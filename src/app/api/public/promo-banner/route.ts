  ...
  try {
    ...
    return NextResponse.json({
      ...
      banner: {
        ...
        description: banner.description || "আলাদা কিনলে ৳১৪৯ + ৳১৪৯ = ৳২৯৮। আজকের স্পেশাল কম্বো বান্ডেলে ১,১৫৯+ পৃষ্ঠার দুটি সম্পূর্ণ বই পাচ্ছেন মাত্র ৳১৯৯-এ (৳১০০ নিশ্চিত ছাড়)!",
        couponCode: banner.couponCode || "",
        discountAmount: banner.discountAmount || 100,
        discountType: banner.discountType || "fixed",
        ctaText: banner.ctaText || "২-বুক মাস্টার বান্ডেল কিনুন (৳১৯৯)",
        offerTag: banner.offerTag || "৳১০০ OFF",
