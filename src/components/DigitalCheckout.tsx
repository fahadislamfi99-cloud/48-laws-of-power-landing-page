...
export default function DigitalCheckout() {
  ...
  return (
    <section id="checkout" ref={containerRef} className="py-12 sm:py-16 lg:py-20 bg-[#08080A] border-t border-[#26262A] relative overflow-hidden">
      ...
      <div className="max-w-xl mx-auto px-3.5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-2.5 sm:space-y-3 mb-6 sm:mb-8 reveal">
          ...
          <p className="text-[#B8B0A4] text-xs sm:text-sm max-w-md mx-auto leading-relaxed">
            নিচে আপনার জিমেইল প্রদান করে বিকাশ পেমেন্ট সম্পন্ন করুন। সাথে সাথেই ডাউনলোড লিংক সক্রিয় হবে।
          </p>
        </div>

        {/* Checkout Card */}
        <div className="bg-[#111114] rounded-2xl sm:rounded-3xl p-4 sm:p-7 md:p-8 border border-[#2A2A2E] reveal-scale reveal-stagger-1 shadow-2xl relative space-y-5 sm:space-y-6 hover:border-[#C8A45C]/35 transition-all duration-300">
