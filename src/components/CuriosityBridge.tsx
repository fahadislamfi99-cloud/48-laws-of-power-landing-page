...
export default function CuriosityBridge({ onOpenOrderModal }: CuriosityBridgeProps) {
  ...
  return (
    <section className="py-14 lg:py-20 bg-[#08080A] border-t border-[#26262A] overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl space-y-2.5 sm:space-y-3 mb-8 sm:mb-10">
          ...
          <p className="sr-desc text-base sm:text-lg text-[#B8B0A4] leading-relaxed">
        ...
        <div className="border-t border-[#2A2A2E] divide-y divide-[#2A2A2E]">
          {pillars.map((pillar, idx) => (
            <div
              key={idx}
              className="sr-left py-5 sm:py-6 grid grid-cols-1 sm:grid-cols-12 gap-2 sm:gap-4 items-baseline px-3 sm:px-4 rounded-xl transition-all duration-300 hover:bg-[#111114] md:hover:translate-x-1 group cursor-default"
            >
        ...
        {/* Action */}
        <div className="sr-fade-up mt-8 pt-6 border-t border-[#2A2A2E] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
