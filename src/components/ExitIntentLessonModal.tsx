...
export default function ExitIntentLessonModal({ onClaimOffer }: ExitIntentLessonModalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] sm:w-[580px] h-[340px] sm:h-[580px] bg-[#C8A45C]/12 rounded-full blur-[130px] pointer-events-none" />

      {/* Modal Shell */}
      <div
        ref={panelRef}
        className="relative w-full max-w-[460px] md:max-w-[620px] max-h-[92vh] overflow-y-auto bg-[#0D0D10] rounded-3xl border border-[#2A2A2E] shadow-[0_25px_80px_rgba(0,0,0,0.9)] animate-scaleIn p-5 sm:p-7 md:p-8 text-left space-y-5 my-auto"
