...
import { Crown, Download, Menu, X, Sparkles } from "lucide-react";
...
export default function Header({ onOpenOrderModal }: HeaderProps) {
  ...
  const navLinks = [
    ...
    { name: "ডিজিটাল ফিচারস", href: "#digital-features" },
    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ...
          : "bg-[#FAF8F5]/90 backdrop-blur-xs border-b border-[#EDE4D0]/70 py-4"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Download className="w-3.5 h-3.5 text-[#E6C67E] stroke-[2.4]" />
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#FAF8F5] border-b border-[#E5DCBE] px-5 pt-4 pb-6 space-y-3 shadow-xl">
          ...
          <div className="pt-2">
            ...
            >
              <Download className="w-4 h-4 text-[#E6C67E]" />
