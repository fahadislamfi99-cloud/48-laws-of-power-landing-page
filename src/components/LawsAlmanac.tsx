              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0 mt-1 sm:mt-0">
                    ...
                    <div
                      className={`w-7 h-7 rounded-full bg-[#08080A] border border-[#2A2A2E] flex items-center justify-center text-[#8A8278] transition-all duration-300 ${isExpanded ? "rotate-180 bg-[#C8A45C] text-[#08080A] border-[#C8A45C]" : "group-hover:border-[#C8A45C]/30 group-hover:text-[#C8A45C]"
                        }`}
                    >
