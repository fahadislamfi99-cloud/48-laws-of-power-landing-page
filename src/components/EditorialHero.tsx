  ...
  return (
    <section className="relative pt-24 sm:pt-28 pb-10 md:pt-32 md:pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-0 left-[-10%] w-[280px] sm:w-[500px] h-[280px] sm:h-[500px] bg-[#C8A45C]/[0.04] rounded-full blur-[100px] sm:blur-[120px] animate-[orbFloat2_15s_ease-in-out_infinite]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        {/* Top bar */}
        <div className={`flex flex-wrap items-center justify-between gap-3 pb-4 sm:pb-6 border-b border-[#2A2A2E] text-xs transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4"}`}>
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-[#D1C9BC] text-xs sm:text-sm">সম্পূর্ণ বাংলা ডিজিটাল সংস্করণ</span>
          </div>
        ...
        {/* Hero Grid */}
        <div className="py-6 sm:py-8 lg:py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            <div className="space-y-3">
              ...
              <div className={`flex items-center gap-3 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                ...
                <span className="text-[11px] font-mono font-bold tracking-[0.2em] sm:tracking-[0.25em] text-[#C8A45C] uppercase">
                  ROBERT GREENE&apos;S MASTERWORK
                </span>
              </div>

              {/* Title */}
              <h1 className="text-4xl sm:text-6xl md:text-7xl xl:text-8xl font-display font-bold tracking-tight leading-[0.95]">
              ...
              {/* Bengali subtitle */}
              <h2 className={`text-base sm:text-xl lg:text-2xl font-bengali-serif font-bold text-[#D1C9BC] leading-snug transition-all duration-700 delay-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
                {siteConfig.bookSubtitle}
              </h2>
            </div>

            {/* Body */}
            <p className={`text-[#D1C9BC] text-sm sm:text-base lg:text-lg leading-[1.85] max-w-xl transition-all duration-700 delay-[800ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            ...
            {/* CTAs */}
            <div className={`flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 transition-all duration-700 delay-[900ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              <button
                ref={ctaRef}
                onClick={onOpenOrderModal}
                className="relative inline-flex items-center justify-center gap-2.5 sm:gap-3 px-7 sm:px-8 py-3.5 sm:py-4 rounded-full btn-gold text-sm sm:text-base cursor-pointer hover-lift btn-shimmer group whitespace-nowrap shadow-lg"
              >
              ...
              <a
                href="#deep-dive"
                className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3.5 sm:py-4 rounded-full bg-transparent text-[#C8A45C] font-semibold text-xs sm:text-sm border border-[#C8A45C]/30 hover:border-[#C8A45C]/60 hover:bg-[#C8A45C]/5 transition-all hover-lift group whitespace-nowrap"
              >
            ...
            {/* Feature pills */}
            <div className={`pt-4 sm:pt-5 border-t border-[#2A2A2E] grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 text-xs text-[#D1C9BC] font-medium transition-all duration-700 delay-[1000ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
              {[
                ...
                <div
                  key={text}
                  className="flex items-center gap-2.5 p-2.5 rounded-xl border border-[#1A1A1E] sm:border-transparent transition-all duration-300 hover:bg-[#111114] hover:border-[#2A2A2E] group/feat"
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#C8A45C]/10 flex items-center justify-center shrink-0 group-hover/feat:bg-[#C8A45C]/20 transition-colors">
          ...
          <div className={`lg:col-span-5 flex flex-col items-center lg:items-end transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-10 scale-95"}`}>
            <div className="relative max-w-[260px] sm:max-w-[320px] lg:max-w-[360px] xl:max-w-[400px] w-full">
              
              {/* Radial glow */}
              <div className="absolute inset-[-20%] bg-gradient-to-tr from-[#C8A45C]/[0.12] via-[#C8A45C]/[0.04] to-transparent rounded-full blur-[70px] sm:blur-[90px] -z-10 animate-pulseGlow" />
              ...
              >
                <img
                  ...
                  className="w-full max-w-[240px] sm:max-w-[300px] lg:max-w-[340px] h-auto object-contain drop-shadow-[0_20px_35px_rgba(0,0,0,0.5)] animate-floatSlow relative z-10"
                />
              </div>

              {/* Specs badge */}
              <div className="mt-3 sm:mt-4 flex items-center justify-between text-xs px-4 py-3 rounded-2xl bg-[#111114] border border-[#2A2A2E] transition-all duration-500 hover:border-[#C8A45C]/30 shadow-md">
