        ...
        <div className="py-4 sm:py-8 lg:py-12 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 xl:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-end">
            <div className="relative max-w-[210px] xs:max-w-[240px] sm:max-w-[320px] lg:max-w-[360px] xl:max-w-[400px] w-full">
              ...
              {/* Radial glow */}
              <div className={`absolute inset-[-20%] bg-gradient-to-tr from-[#C8A45C]/[0.12] via-[#C8A45C]/[0.04] to-transparent rounded-full blur-[60px] sm:blur-[90px] -z-10 animate-pulseGlow transition-opacity duration-[1300ms] delay-[150ms] ${isVisible ? "opacity-100" : "opacity-0"}`} />

              {/* 1. Book Entrance */}
              <div
                ref={bookRef}
                className={`relative flex justify-center items-center py-1 sm:py-2 transition-all duration-[1300ms] delay-[150ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${
