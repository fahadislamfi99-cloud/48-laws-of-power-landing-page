...
export default function Preloader({ onComplete }: PreloaderProps) {
  ...
  useEffect(() => {
    ...
    const duration = 650; // 0.65s smooth, snappy luxury loader
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center space-y-6 px-4">
        ...
        <div className="relative group transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">
        ...
        {/* Typography */}
        <div className="space-y-1.5 transition-all duration-600 delay-150 ease-[cubic-bezier(0.16,1,0.3,1)]">
        ...
        <div className="w-48 sm:w-56 space-y-2 pt-2 transition-opacity duration-400 delay-200">
          {/* Progress Track */}
