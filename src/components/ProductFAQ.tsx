...
const faqs: FAQItem[] = [
  {
    ...
    a: "এটি সম্পূর্ণ বাংলা অনুবাদকৃত হাই-রেজোলিউশন ডিজিটাল PDF সংস্করণ (৪৫২ পৃষ্ঠা)। কোনো ফিজিক্যাল কপি বা কুরিয়ার ডেলিভারি নেই; পেমেন্টের সাথে সাথেই তাৎক্ষণিকভাবে ডাউনলোড করে পড়তে পারবেন।",
  },
  {
    q: "পেমেন্টের পর কীভাবে ফাইলটি পাব?",
    a: "বিকাশ, নগদ বা রকেটে পেমেন্ট করে TrxID দিয়ে সাবমিট করার সাথে সাথে স্ক্রিনে সরাসরি ডাউনলোড বাটন দেখতে পাবেন। একইসাথে ইমেইল ও হোয়াটসঅ্যাপেও লিংক পৌঁছে যাবে।",
  },
  {
