      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-x-hidden overflow-y-auto">
          ...
          <motion.div
            ...
            data-lenis-prevent
            className="relative w-full max-w-4xl bg-[#111114] rounded-3xl shadow-2xl border border-[#2A2A2E] flex flex-col max-h-[90dvh] overflow-hidden my-auto z-10 will-change-[transform,opacity]"
          >
            {/* Header */}
            ...
            <div className="p-3 sm:p-6 overflow-y-auto space-y-3 sm:space-y-4 divide-y divide-[#2A2A2E] bg-[#111114]">
              {filteredLaws.length === 0 ? (
                <div className="py-12 text-center text-[#A8A095] text-sm">
