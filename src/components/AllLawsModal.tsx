...
export default function AllLawsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6 animate-fadeIn">
      {/* Modal Container */}
      <div className="relative w-full max-w-4xl bg-[#FAF8F5] rounded-3xl shadow-2xl border border-[#DFCFA8] flex flex-col max-h-[90vh] overflow-hidden text-stone-900">
        ...
        <div className="p-4 sm:p-5 bg-[#FAF6EE] border-b border-[#EFE8DA] space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 bg-white rounded-xl border border-[#D5C7A8] text-stone-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-[#C59B4B] text-sm shadow-2xs"
            />
          </div>
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-medium whitespace-nowrap transition-colors cursor-pointer ${
                  selectedCategory === cat.id
                    ? "bg-[#18191D] text-[#E6C67E] font-bold shadow-xs border border-[#C59B4B]/50"
        ...
        <div className="p-4 sm:p-5 bg-[#F5EFE6] text-stone-900 border-t border-[#E2D5BA] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#18191D] hover:bg-[#25272F] text-[#E6C67E] font-bold text-sm shadow-md border border-[#C59B4B]/60 cursor-pointer"
          >
